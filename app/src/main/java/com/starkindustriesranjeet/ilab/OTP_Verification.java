...
public class OTP_Verification extends AppCompatActivity {
    ...
    String myname,mymobile,phone,myaddress,myemail,mypassword;


    @Override
    public void onBackPressed() {

        AlertDialog.Builder builder = new AlertDialog.Builder(OTP_Verification.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyOTP=(Button)findViewById(R.id.button3);
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    startActivity(intent);
                    Toast.makeText(OTP_Verification.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(OTP_Verification.this, "Please Enter Correct OTP, Verification Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
